...
- Sofi usa `women_sofi_atlas_v1.png` para walk (12 frames de `32x48`) y `women_sofi_idle_atlas_v1.png` para idle animado en cuatro direcciones (16 frames de `32x48`), con escala runtime `1.24` y depth por pies. Mili y Cami todavía son cuerpos construidos con rectángulos de Phaser.
